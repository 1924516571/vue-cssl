      ...
      >
        <template v-for="item in columns">
          <template v-if="item.slot">
            <suc-table-column :type="item.type" :prop="item.key" :label="item.title" :width="item.width" :key="item.id" :sortable="item.sortable">
          ...
          <template v-else>
            <suc-table-column :type="item.type" :index="indexMethod" :prop="item.key" :label="item.title" :width="item.width" :key="item.id" :sortable="item.sortable"></suc-table-column>
          </template>
        </template>
      </suc-table>
    </div>
