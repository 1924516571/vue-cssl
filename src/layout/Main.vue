<template>
  <div class="main_view">
    ...
    <transition name="fade">
      <div class="warning" v-if="flag && routePath !== '/main/homePage/alarm'">
        <div class="header">
...
export default class mainView extends Vue {
  ...
  onclick() {
    this.$router.push("/main/homePage/alarm");
  }
  warnInfo: any = {};
  audioCmp: any = document.querySelector("#video");
  getWarningList() {
    // const urlwebscket = "ws://112.25.132.104:18090/ws/iot/" + this.userId;
    const urlwebscket = "ws://112.25.132.104:18090/ws/iot/" + this.userId;
