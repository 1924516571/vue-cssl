  ...
  <el-dialog :title="title" :visible.sync="model" close-on-click-modal:false :before-close="onCancel" v-if="model">
    <el-form :model="formParams" :rules="rules" ref="yinjForm" label-width="auto" size="small">
      ...
      <el-form-item label="泵站名称">
        <el-input v-model="formParams.bengmc"></el-input>
      </el-form-item>
      <el-form-item label="泵站类型">
        <suc-select v-model="formParams.zhantype" :options="shuizhatypeData" :config="{ placeholder: '请选择泵站类型', clearable: true }" style="width:100%"> </suc-select>
      </el-form-item>
      <el-form-item label="机组台数">
        <el-input v-model="formParams.num"></el-input>
      </el-form-item>
      <el-form-item label="装机容量（KW）">
        <el-input v-model="formParams.capacity"></el-input>
      </el-form-item>

      <el-form-item label="设计流量(m³/s)">
        <el-input v-model="formParams.desnum"></el-input>
      </el-form-item>

      <el-form-item label="水泵类型">
        <el-input v-model="formParams.bengtype"></el-input>
      </el-form-item>

      <el-form-item label="水泵型号">
        <el-input v-model="formParams.model"></el-input>
      </el-form-item>
      <el-form-item label="进水池尺寸(m²)">
        <el-input v-model="formParams.insize"></el-input>
      </el-form-item>
      <el-form-item label="出水池尺寸(m²)">
        <el-input v-model="formParams.outsize"></el-input>
      </el-form-item>
      <el-form-item label="泵房面积(m²)">
        <el-input v-model="formParams.barea"></el-input>
      </el-form-item>
      <el-form-item label="管理房面积(m²)">
        <el-input v-model="formParams.glarea"></el-input>
      </el-form-item>
      <el-form-item label="占地面积(m²)">
        <el-input v-model="formParams.zdarea"></el-input>
      </el-form-item>
      <el-form-item label="进水河道">
        <el-input v-model="formParams.inriver"></el-input>
      </el-form-item>
      <el-form-item label="出水河道">
        <el-input v-model="formParams.outriver"></el-input>
      </el-form-item>
      <el-form-item label="受益面积（亩）">
        <el-input v-model="formParams.syarea"></el-input>
      </el-form-item>
      <el-form-item label="新建时间或改建">
        <el-date-picker v-model="formParams.gztime" type="year" placeholder="选择年" value-format="yyyy"> </el-date-picker>
      </el-form-item>
      ...
      <el-form-item label="现状管理模式">
        <el-input v-model="formParams.glmodel"></el-input>
      </el-form-item>
      ...
      <el-form-item label="电度(千瓦时)">
        <el-input v-model="formParams.power"></el-input>
      </el-form-item>
      <el-form-item label="电度更新日期">
        <el-date-picker v-model="formParams.powertime" type="year" placeholder="选择年" value-format="yyyy"> </el-date-picker>
      </el-form-item>
