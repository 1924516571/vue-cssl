  ...
  <el-dialog :title="title" :visible.sync="model" close-on-click-modal:false :before-close="onCancel" v-if="model">
    <el-form :model="formParams" :rules="rules" ref="yjForm" label-width="auto" size="small" class="form scroll">
      ...
      <el-form-item label="部门">
        <el-input v-model="formParams.department"></el-input>
      </el-form-item>
      <el-form-item label="防汛值班电话">
        <el-input v-model="formParams.dutytel"></el-input>
      </el-form-item>
      <el-form-item label="分管领导">
        <el-input v-model="formParams.dutyleader"></el-input>
      </el-form-item>
      <el-form-item label="联系电话">
        <el-input v-model="formParams.leadertel"></el-input>
      </el-form-item>

      <el-form-item label="联络员1">
        <el-input v-model="formParams.lisison1"></el-input>
      </el-form-item>
      <el-form-item label="联系电话1">
        <el-input v-model="formParams.lisison1tel"></el-input>
      </el-form-item>
            <el-form-item label="联络员2">
        <el-input v-model="formParams.lisison2"></el-input>
      </el-form-item>
      <el-form-item label="联系电话2">
        <el-input v-model="formParams.lisison2te2"></el-input>
      </el-form-item>
    </el-form>
...
export default class ZbModal extends Vue {
  ...
  // }
  // 值班领导
  // async getDutyleader(value: any) {
  //   if (value == undefined) {
  //     this.formParams.dutyleader = "";
  //   }
  // }

  // 技术人员
  // async getSkiller(value: any) {
  //   if (value == undefined) {
  //     this.formParams.skiller = "";
  //   }
  // }

  // 获取白班
  // async getDayshift(value: any) {
  //   if (value == undefined) {
  //     this.formParams.dayshift = "";
  //   }
  // }
  // 改变晚班
  // async getNightshift(value: any) {
  //   if (value == undefined) {
  //     this.formParams.nightshift = "";
  //   }
  // }

  // 值班类型
  // async getType(value: any) {
  //   if (value == undefined) {
