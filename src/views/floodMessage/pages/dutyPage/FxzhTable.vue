  ...
  <div class="info">
    <div class="info-view bg-shadow">
      <div class="top">
        ...
        <div class="top-item" style="font-size:25px;letter-spacing: 5px;">{{ headerDate }}年度防汛值班通讯录(防指成员单位)</div>
        <div class="top-item">
          ...
          <el-upload
            ...
            action="api/wjServer/fangxunjc/zhibanCompany/import"
            accept=".xls,.xlsx"
      ...
      <div class="content">
        <table-page :columns="columns" :tableData="tableData" v-loading="loading" :pageParams="pageParams" @get-page="getPage" @get-size="getSize">
    ...
    <fxzh-modal :title="modalTitle" :model="model"  :formParams="formParams" @on-submit="oncreate" @toggle="toggle"></fxzh-modal>
...
export default class Enterprise extends Vue {
  ...
  async setEdit() {
    this.loading = true;
    let url = "wjServer/fangxunjc/zhibanCompany/edit";
  ...
  async editInfo(params: any) {
    let url = "wjServer/fangxunjc/zhibanCompany/getDetail";
  ...
  // 模板下载
  downLoadTem() {
    location.href = "api/wjServer/年度防汛值班通讯录（防指成员单位）模板.xlsx";
  ...
  async onpage() {
    ...
    let url = "wjServer/fangxunjc/zhibanCompany/infoList";
