  ...
  <el-dialog :title="title" :visible.sync="model" close-on-click-modal:false :before-close="onCancel" v-if="model">
    <el-form :model="formParams" :rules="rules" ref="yjForm" label-width="auto" size="small" class="form scroll">
      ...
      <el-form-item label="技术负责人">
        <el-input v-model="formParams.skiller"></el-input>
      </el-form-item>
      <el-form-item label="联系电话">
        <el-input v-model="formParams.skillertel"></el-input>
      </el-form-item>
      <el-form-item label="联络员">
        <el-input v-model="formParams.liaison"></el-input>
      </el-form-item>
      <el-form-item label="联系电话">
        <el-input v-model="formParams.liaisontel"></el-input>
      </el-form-item>
