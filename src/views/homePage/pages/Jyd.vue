<template>
  <div class="module-view">
    <!-- 地图层 -->
    <div class="main-map">
      <map-manage :sxflag="sxflag" @onmarkerClick="onmarkerClick" @mapZoom="mapZoom" ref="maps" @mapSingClick="mapSingClick">
        <!-- 站点弹框 -->
    ...
    <div :class="flag ? 'tc' : 'tc1'">
      <overview-panel-yld :sendType="sendType" ref="child" @get-wq="getWq" @getSx="getSx" @childClick="getClickType"></overview-panel-yld>
    </div>
...
import { OverviewPanel, YlzModal, SwModal, ZbzModal, WzckModal, OverviewPanelSq,OverviewPanelYld} from "./overviewPage";
...
export default class OverView extends Vue {
  ...
  async getYlzLine() {
    ...
    // this.ylzLineParam.startTime = "2022-03-26 08";
    // this.ylzLineParam.endTime = "2022-05-26 08";
    ...
    if (this.hisInfo.length > 0) {
      ...
      let arr = this.options1.series[1].data;
      var max = Math.max(...arr);
      var min = Math.min(...arr);
      this.options1.yAxis.min = min;
