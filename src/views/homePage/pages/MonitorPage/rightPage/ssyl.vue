<template>
  ...
  <div class="monitor-view">
    <div class="monitor-item">
      <search-component placeholderTxt="请输入站点名称" @input="getInput"></search-component>
    </div>
    <div class="table-item" v-show="!seen" @mouseenter="onenter" @mouseleave="onleave">
      <table-page :tableData="tableData" :columns="columns" :customHeight="630" :tableRowClassName="tableRowClassName" :pageParams="pageParams" @getPage="getPage" @getSize="getSize"> </table-page>
    </div>
