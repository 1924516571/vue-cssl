<template>
  <div class="module-view">
    ...
    <div :class="flag ? 'tc' : 'tc1'">
      <overview-panel-sq :sendType="sendType" ref="child" @get-wq="getWq" @getSx="getSx" @childClick="getClickType"></overview-panel-sq>
    </div>
...
import { OverviewPanel, YlzModal, SwModal, ZbzModal, WzckModal, OverviewPanelSq } from "./overviewPage";
