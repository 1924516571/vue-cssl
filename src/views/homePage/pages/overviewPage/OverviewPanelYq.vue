        ...
        <div class="img-view scroll">
          ...
          <div class="check-item" v-if="type == 0">
            ...
            <div class="yq_content">
              <el-checkbox class="boxStyle" :indeterminate="SwzisIndeterminate" v-model="allCheckSwz" @change="getAllSw">自建雨量站</el-checkbox>
          ...
          <div class="check-item" v-if="type == 1">
            ...
            <div class="yq_content">
              <el-checkbox class="boxStyle" :indeterminate="YlzisIndeterminate" v-model="YlzallCheck" @change="YlzgetAll">气象局雨量站</el-checkbox>
...
export default class OverviewPanel extends Vue {
  ...
  YlzcheckboxGroupValue: any = ["ylz1", "ylz2", "ylz3", "ylz4"];
  ...
  SwzcheckboxGroupValue: any = ["ylz1", "ylz2", "ylz3", "ylz4"];
  ...
  YldgetAll(val: any) {
    if (val) {
      var newArr: any = this.YldData.map((e: any) => {
        return e.label;
      });
  ...
  // 气象局雨量站
  async getQxjRainPoint() {
    const url = "wjServer/wj/gis/bigP";
    this.markers = [];
