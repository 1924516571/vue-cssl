...
export default class TransferPlan extends Vue {
  ...
  async getTree() {
    ...
    let data = await publicApi.getWithParam(url, { splb: "下穿立交视频" });
  ...
  async getNode(data: any) {
    ...
    if (a.result) {
      if (a.data.token != "") {
        ...
        // this.getVideo("https://pps.sd-play.com/20220610/et3sWrbS/index.m3u8");
  ...
  getLinkUrl() {
    window.open("http://112.25.132.104:18079", "_blank");
  }
  downloadSoftware() {
